...
${OBJECTDIR}/Alignment.o: Alignment.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Alignment.o Alignment.cpp

${OBJECTDIR}/IntronStorage.o: IntronStorage.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/IntronStorage.o IntronStorage.cpp
...
${OBJECTDIR}/ScoreMatrix.o: ScoreMatrix.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ScoreMatrix.o ScoreMatrix.cpp
...
${OBJECTDIR}/test/t_matrix.o: test/t_matrix.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/test/t_matrix.o test/t_matrix.cpp

${OBJECTDIR}/test/t_parser.o: test/t_parser.cpp
	${MKDIR} -p ${OBJECTDIR}/test
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/test/t_parser.o test/t_parser.cpp
